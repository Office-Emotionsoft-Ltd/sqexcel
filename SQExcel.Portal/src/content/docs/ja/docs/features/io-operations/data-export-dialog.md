---
title: データ出力
description: データ出力機能とダイアログから設定する時のオプション詳細。
---

[IO操作画面](/ja/docs/features/io-operations/) で「データ出力」ボタンをクリックすると、データ出力ダイアログが開きます。データベースから検索条件に合致するデータを取得し、入力シートへ書き出します。
